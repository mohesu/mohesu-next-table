...
export function DataTablePagination<TData>({
    ...
    const getNumberOfPages = (page?: number, pageSize?: number, totalItems?: number) => {
    ...
    return (
        <div className="flex items-center justify-between px-2">
            <div className=" md:flex-1 flex items-center space-x-4">
                ...
                ">
                    {selectedRows} of {totalRows} row(s) selected. {getNumberOfPages(page, pageSize, totalItems)}
                </div>
            ...
            <div className="flex items-center space-x-6 lg:space-x-8">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        <SelectTrigger className="h-8 w-[70px]">
                            <SelectValue placeholder={pageSize ?? table.getState().pagination.pageSize} />
                        </SelectTrigger>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Button
                        ...
                        disabled={getNumberOfPages(page, pageSize, totalItems) ? page == (getNumberOfPages(page, pageSize, totalItems)! - 1) : !table.getCanNextPage()}
                    >
                        <span className="sr-only">Go to next page</span>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            if (onPageChange && getNumberOfPages(page, pageSize, totalItems) != null) {
                        ...
                        disabled={getNumberOfPages(page, pageSize, totalItems) != null ? page == (getNumberOfPages(page, pageSize, totalItems)! - 1) : !table.getCanNextPage()}
